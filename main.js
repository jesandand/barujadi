...
const connectToWhatsApp = async () => {
    ...
    require('./lib/myfunc')
    require('./message/ahmad')
    nocache('./message/help', module => console.log(chalk.greenBright('[ KOLEKSIBOT ]  ') + time + chalk.cyanBright(` "${module}" Updated!`)))
    nocache('./lib/myfunc', module => console.log(chalk.greenBright('[ KOLEKSIBOT ]  ') + time + chalk.cyanBright(` "${module}" Updated!`)))
    nocache('./message/ahmad', module => console.log(chalk.greenBright('[ KOLEKSIBOT ]  ') + time + chalk.cyanBright(` "${module}" Updated!`)))
	...
	fadly.ev.on('messages.upsert', async m => {
	    ...
	    require('./message/ahmad')(fadly, msg, m, setting, store, welcome, left, set_welcome_db, set_left_db, db_respon_list, sewa, opengc, _afk, set_proses, set_done, set_open, set_close)
	})
