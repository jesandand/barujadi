...
*• Penyedia Dari :*
   ...
   *- Module*`
        ...
        case prefix+'owner': case prefix+'dev':
            ...
            break
        case prefix+'groupbot': case prefix+'grupku': case prefix+'gcbot':
            addCountCmd('#groupbot', sender, _cmd)
            var gcofficial = 'https://chat.whatsapp.com/'+await fadly.groupInviteCode("972502255007-1451543219@g.us")
            var gc1 = 'https://chat.whatsapp.com/'+await fadly.groupInviteCode("972502255007-1451543219@g.us")
            var gc2 = 'https://chat.whatsapp.com/'+await fadly.groupInviteCode("972502255007-1451543219@g.us")
            var tek = `Jangan lupa join grup untuk mengetahui informasi lebih lanjut tentang bot\n\nGroup Official : ${gcofficial}\nGroup 1 : ${gc1}\nGroup 2 : ${gc2}\n\nJangan lupa juga untuk Donasi supaya admin semakin semangat dalam mengembangkan bot ini, terimakasih.`
            replyDeface(tek)
            break
